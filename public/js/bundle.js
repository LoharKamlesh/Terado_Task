...
var logOutTime = document.querySelector(".logout__data");
var logInTime = document.querySelector(".login__data");
...
document.querySelector("#files").addEventListener("change", function (e) {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    fileReader.addEventListener("load", function (e) {
      ...
      div.innerHTML = "<img class='thumbnail' src='".concat(picFile.result, "' title='").concat(picFile.name, "' /> ");
